Feature: Consolidated View Business Linked Contacts
  ...
  @basic
  Scenario: Contacts list appears in left hand side pane
    Given I am on home page
    When I click the Documentation tab
    Then I see the correct documentation page title
  ...
  @basic
  Scenario: On clicking on a contact, the right-hand side pane appears with the correct fields and a permissions table with correct columns.
    Given I am on home page
    When I click the Documentation tab
    Then I see the correct documentation page title
